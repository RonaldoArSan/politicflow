  ...
  return (
    <header className="h-16 border-b border-border/50 bg-surface-card/80 backdrop-blur-sm flex items-center justify-between px-4 lg:px-6 sticky top-0 z-30">
      ...
      <div className="flex items-center gap-2">
        {/* Search */}
        <div className="hidden md:flex items-center gap-2 bg-surface-hover rounded-lg px-3 py-2 w-64 group focus-within:ring-2 focus-within:ring-accent/30 transition-all">
